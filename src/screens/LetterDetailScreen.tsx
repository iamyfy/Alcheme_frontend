...
export function LetterDetailScreen({ onBack }: LetterDetailScreenProps) {
  return (
    // letter-detail-screen: gentle full-screen fade-in that picks up
    // where the MailboxScreen envelope overlay left off
    <section className="screen letter-detail-screen">
      ...
      {/* Letter card — slides up as if rising out of the opened envelope */}
      <PaperCard
        variant="letter"
        hasTape
        tapeColor="lavender"
        tapePosition="both"
        className="letter-detail-card enter enter-1"
      >
